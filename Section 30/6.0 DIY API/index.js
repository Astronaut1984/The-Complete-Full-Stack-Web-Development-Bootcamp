...
app.put("/jokes/:id", (req, res) => {
  ...
  const index = jokes.findIndex((joke) => joke.id === parseInt(jokeId));
...
app.patch("/jokes/:id", (req, res) => {
  ...
  if (!jokeType && !jokeText) {
    res.json(jokes.find((joke) => joke.id === parseInt(jokeId)));
    return;
  }
  ...
  const newJoke = {
    id: parseInt(jokeId),
    jokeText: jokeText || jokes[index].jokeText,
    jokeType: jokeType || jokes[index].jokeType,
  };
